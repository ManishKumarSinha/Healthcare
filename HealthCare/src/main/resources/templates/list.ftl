<div class="generic-container">
    <div class="panel panel-default">
        <!-- Default panel contents -->
                <div class="panel-heading"><span class="lead">Health Care </span></div>
        <div class="panel-heading"><span class="lead">Add Institutions </span></div>
    ...
    <div class="panel panel-default">
        <!-- Default panel contents -->
        <div class="panel-heading"><span class="lead">Institutions Details</span></div>
		<div class="panel-body">
			<div class="table-responsive">
		        <table class="table table-hover">
		        	...
		        	<table class="table table-hover">
		        	 <div class="panel-heading"><span class="lead">Patients Details</span></div>
			            <thead>
			            <tr>
			                <th>ID</th>
			                <th>NAME</th>
