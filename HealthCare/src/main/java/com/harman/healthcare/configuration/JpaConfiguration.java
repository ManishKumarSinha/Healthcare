package com.harman.healthcare.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.harman.healthcare.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.harman.healthcare.model" });
